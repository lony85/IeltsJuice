...
class FragmentPlacementResult:Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val bundle = arguments
            ...
            val score = bundle?.getInt(KEY_testResult)

        when (score) {
            in 0..18 -> {
                binding.txtResultTitle.text = getString(R.string.txtTitleA1)
                binding.icResultA1.context.getDrawable(R.drawable.ic_hand_point_down)
            ...
            in 19..36 -> {
                ...
                binding.icResultA2.context.getDrawable(R.drawable.ic_hand_point_down)
            ...
            in 37..54 -> {
                ...
                binding.icResultB1.context.getDrawable(R.drawable.ic_hand_point_down)
            ...
            in 55..72 -> {
                ...
                binding.icResultB2.context.getDrawable(R.drawable.ic_hand_point_down)
            ...
            in 73..90 -> {
                ...
                binding.icResultC1.context.getDrawable(R.drawable.ic_hand_point_down)
