...
object PlacementTestQuestions{
    ...
    fun getQuestions():ArrayList<Question> {
        ...
        val que4 = Question(4,"4. A: ____ use your dictionary? B: Sure. Here you are.","Could I","Could you","Do I","",1,1)
        ...
        val que7 = Question(7,"7. A: Do you sell stamps?  B: Yes, we do. How ____ do you want?","any","many","much","",2,1)
        val que8 = Question(8,"8. A: Sorry I'm so late. B: That's ____ .","OK","great","right","",1,1)
        ...
        val que11 = Question(11,"11. A: Is this a good time to talk? B: Sorry, no. I ____ dinner.","cook","am cooking","cooking","",2,1)
        ...
        val que19 = Question(19,"19. A: Did George finish the report?  B: No. He ____ it tomorrow.","finishes","is going to finish","finished","",2,1)
        val que20 = Question(20,"20. Paula ____ loves working with children.","very","really","much","",2,1)
        val que21 = Question(21,"21. A: Is Ottawa the capital of Canada? B: I think ____ .","is","ok","so","right",3,1)
        ...
        val que26 = Question(26,"26. A: Can I make myself a cup of coffee? B: Of course. You ____ to ask.","haven't","mustn't","needn't","don't have",4,1)
        ...
        val que33= Question(33,"33. A: My wife's not very well. B: Oh, ____.","it doesn't matter","I do apologize","sorry to hear that","not bad, thanks.",3,1)
        ...
        val que42= Question(42,"42. A: Shall we go to The Riceboat for dinner? B: It ____ be fully booked. They're sometimes busy on Mondays.","will","may","can","must",2,2)
        ...
        val que50= Question(50,"50. A: I've got a terrible headache, and it won't go away. B: Have you tried ____ some aspirin?","to take","take","took","taking",4,1)
        ...
        val que53= Question(53,"53. A: I was wondering ____ I could ask you some questions. B: Sure, go ahead.","what","if","that","how",2,1)
        val que54= Question(54,"54. A: What clothes should I pack for a trip to Boston? B: Well, it depends ____ the time of year that you go.","on","with","up","to",1,1)
